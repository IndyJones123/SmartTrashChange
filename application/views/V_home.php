    ...
    <main>
        ...
        <div class="container">
            <div class="rekomendasi">
                <h3>Cara baru memanfaatkan sampah,</h3>
                <hr>
            </div>
        </div>
        <!-- end -->
        ...
        <div class="container mt-5">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<?php echo base_url(); ?>assets/assets/iklan-banner-1.jpg" class="d-block" alt="..."/>
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Memisahkan sampah</h5>
                            <p>
                                Pilah sampahmu berdasarkan jenisnya
                            </p>
                        </div>
                    </div>

                    <div class="carousel-item">
                        <img src="<?php echo base_url(); ?>assets/assets/iklan-banner-2.jpg" class="d-block" alt="..."/>
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Kumpulkan kertas yang sudah tak terpakai</h5>
                            <p>
                                Barangmu yang tak terpakai mempunyai nilai disini
                            </p>
                        </div>
                    </div>

                    <div class="carousel-item">
                        <img src="<?php echo base_url(); ?>assets/assets/iklan-banner-3.jpg" class="d-block" alt="..."/>
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Dapatkan manfaat dari sampahmu</h5>
                            <p>
                                Jadikan sampah bekas minummu menjadi hasil yang menguntungkan
                            </p>
                        </div>
                    </div>
                </div>
